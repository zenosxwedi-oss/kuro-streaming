...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  const expoPublicNekoBase = `https://${expoPublicDomain}/api/nekopoi`;
  console.log(`Setting EXPO_PUBLIC_NEKO_BASE=${expoPublicNekoBase}`);
  const env = {
    ...process.env,
    EXPO_PUBLIC_DOMAIN: expoPublicDomain,
    EXPO_PUBLIC_REPL_ID: expoPublicReplId,
    EXPO_PUBLIC_NEKO_BASE: expoPublicNekoBase,
  };
